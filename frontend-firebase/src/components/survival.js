  ...
  submitForm() {
    ...
    fetch(API, {
      ...
      .then(responseJson => {
        ...
        this.setState({ prediction1: responseJson.finalPrediction1 });
        this.setState({ prediction2: responseJson.finalPrediction2 });
  ...
  render() {
    ...
    <NavItem>
      <NavLink href="/recommendations">Recommendations</NavLink>
        ...
        <h1 className="centered" style={{color:"black"}}>Survival Assessment</h1>
     ...
     <div  style={{backgroundColor:"rgba(0,0,0,0.5)",margin:"10px",borderRadius:"5%"}}>
        ...
        <h5>
          Likelihood to Decease in next 10 years:{this.state.prediction1}{" "}
        </h5>
        <h5>
          Likelihood of being Alive in next 10 years:{this.state.prediction2}{" "}
        </h5>
      </div>
      </Form>
      </div>
